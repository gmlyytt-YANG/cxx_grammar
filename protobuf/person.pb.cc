...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_person_2eproto = {
  &descriptor_table_person_2eproto_initialized, descriptor_table_protodef_person_2eproto, "person.proto", 295,
...
::PROTOBUF_NAMESPACE_ID::uint8* Person::InternalSerializeWithCachedSizesToArray(
  ...
  // repeated .tutorial.Person.PhoneNumber phones = 4;
  for (auto it = this->phones_.pointer_begin(),
            end = this->phones_.pointer_end(); it < end; ++it) {
    stream->EnsureSpace(&target);
...
// @@protoc_insertion_point(message_byte_size_start:tutorial.Person)
  ...
  // repeated .tutorial.Person.PhoneNumber phones = 4;
  total_size += 1UL * this->phones_size();
